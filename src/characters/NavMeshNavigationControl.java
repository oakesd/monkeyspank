...
public class NavMeshNavigationControl extends AbstractControl {
    ...
    private Vector3f waypointPosition = null; //new Vector3f(20, 0, 20);
    ...
    protected void controlUpdate(float tpf) {
        ...
        System.out.println("Navigating. Spatial position =  " + spatialPosition);
    ...
    public boolean myIsPathfinding(){
        return pathfinderThread.isPathfinding();
    }
